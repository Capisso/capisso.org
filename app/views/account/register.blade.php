...
<div class="row">
    <div class="span4 offset4">
        ...
        <input type="password" class="input-block-level placeholder" name="password_confirm"
               placeholder="Repeat Password"/>
        <label class="checkbox">
            <input type="checkbox" value="term">
            I agree with the {{HTML::linkAction('LegalController@getTerms', 'Terms and Conditions', null, array('target'
            => '_blank'))}}.
        </label>
        <label class="checkbox">
            <input type="checkbox" name="newsletter" value="1" checked>
            I wish to receive newsletter updates <br>
            <span class="muted">Note: </span>You'll get security notices if you're a customer.
        </label>
        <br>
